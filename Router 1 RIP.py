...
# Variables
ip_address = "192.168.122.131" # IP Address
user_name = "admin" # Username
pass_word = "cisco" # Password
password_enable = "cisco" # Enable Password
firstint = "network 10.0.0.0"  # FIRST NETWORK 
secondint = "network 10.0.0.8"  # SECOND NETOWRK
thirdint = "network 192.168.122.131"  # THIRD NETOWRK
Rippcommand = "Router rip"
...
def ripconfigone():
    ...
    if result != 0:
        ...
        print("All of R1 Networks have been advertised using rip")
