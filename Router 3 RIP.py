...
# Variables
ip_address = "192.168.122.215"# IP address
user_name = "admin" # Username 
pass_word = "cisco" # Password
password_enable = "cisco" # Enable Password
firstint = "network 10.0.0.4"  # FIRST NETWORK
secondint = "network 10.0.0.8"  # SECOND NETWORK
thirdint = "network 192.168.122.215"  # THIRD NETWORK 
...
def ripconfigone():
    ...
    if result != 0:
        ...
        print("All of R3 Networks have been advertised using RIP")
